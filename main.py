...
async def deobf_command(ctx, *, link=None):
    ...
    try:
        ...
        if result and len(result) > 10:
            ...
            # Fallback to older methods if auto-deobfuscator fails
            ...
            # Last resort: fallback to the old enhanced deobfuscator
